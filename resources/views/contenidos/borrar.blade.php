...
<h1 class="h3 mb-2 text-gray-800">Eliminar Contenido</h1>
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    ...
                    <form method="post" action="{{ route('destroyContenido', ['contenido'=>$contenido->id]) }}" >
                        @csrf
                        @method('DELETE')
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Título</label>
                        <input disabled class="form-control" name="nombre" value="{{ $contenido->titulo }}">
                        
                      </div>
                      <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Formato</label>
                                <select disabled class="form-control" required name="id_formato" required>
                              ...
                              <div class="mb-3">
                                ...
                                <select disabled class="form-control" name="id_subcategoria" required>
                                    <option value="">Seleccione</option>
                              ...
                              <div class="mb-3">
                                ...
                                <textarea disabled class="form-control" required name="resumen">{{ $contenido->resumen }}</textarea>
                              </div>
                              <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Texto</label>
                                <textarea disabled class="form-control" name="texto">{{ $contenido->texto }}</textarea>
                              ...
                              <div class="mb-3">
                                ...
                                <input  disabled class="form-control" value="{{ $contenido->link }}" name="link">
                              </div>
                               <div class="mb-3">
                              ...
                              <div class="mb-3">
                                ...
                                <select disabled class="form-control" name="id_nivel" required>
                                    <option value="">Seleccione</option>
                              ...
                              <div class="mb-3">
                                ...
                                <select disabled required class="form-control" name="id_autor" required>
                                    <option value="">Seleccione</option>
                              ...
                              <div class="mb-3">
                                ...
                                <select disabled class="form-control" name="id_contribuyente" >
                                     <option value="">Seleccione</option>
                              ...
                              <div class="mb-3">
                                ...
                                <select disabled class="form-control" required name="id_licencia" >
                                     <option value="">Seleccione</option>
                                ...
                                <label for="exampleInputEmail1" class="form-label">Etiquetas</label>
                                    <div>
                                      ...
                                      @foreach($etiquetas_cont as $eti)
                                        ...
                                        @endif
                                      @endforeach
                                      type="checkbox"  disabled name="etiquetas[]" value="{{ $etiqueta->id }}">  
                                    @endforeach                                  
                                </div>                        
