        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Comunidad"
                    aria-expanded="true" aria-controls="Comunidad">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Comunidad</span>
                </a>
                <div id="Comunidad" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="/novedades">Ver todos  <i class="fas fa-fw fa-pen"></i></a>
